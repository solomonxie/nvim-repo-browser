...
export function FileIcon() {
  return (
    <svg viewBox="0 0 16 16" width="18" height="18" className="tree-icon tree-icon-file" aria-hidden="true">
...
export function FolderIcon() {
  return (
    <svg viewBox="0 0 16 16" width="18" height="18" className="tree-icon tree-icon-folder" aria-hidden="true">
